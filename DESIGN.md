...
**Product:** Bedoo — إدارة محطات الطعوم  
...
<nav className="w-60 bg-slate-950 min-h-screen flex flex-col py-4">
  ...
  <div className="px-4 mb-6">
    <span className="text-white font-bold text-lg">بيدو</span>
...
Bedoo technicians use their phones in the field. These rules apply to all pages under `/scan` and `/station/`:
