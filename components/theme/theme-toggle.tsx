...
export function ThemeToggle({ className }: { className?: string }) {
  ...
  return (
    ...
    >
      ...
      />
      {theme === "dark" ? messages.theme.light : messages.theme.dark}
    </button>
  );
}
