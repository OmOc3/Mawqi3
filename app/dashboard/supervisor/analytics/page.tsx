...
function RangeFilter({ dateFrom, dateTo }: { dateFrom: Date; dateTo: Date }) {
  return (
    <form className="grid gap-3 rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-4 shadow-control md:grid-cols-[1fr_1fr_auto]" action="/dashboard/supervisor/analytics">
